...
export async function walletBinaryPath(root,run=exec){
  try{
...
export class Wallet {
  ...
  async start(create=false) {
    ...
    try {
      ...
      this.child=spawn('wsl.exe',['-d','Ubuntu','--exec','sh','-c',script,'zec-desk',bin],{windowsHide:true,stdio:['pipe','pipe','pipe']});
